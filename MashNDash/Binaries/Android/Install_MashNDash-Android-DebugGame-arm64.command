...
if [ $? -eq 0 ]; then
	...
	$ADB $DEVICE shell 'rm -r $EXTERNAL_STORAGE/Download/obb/com.YourCompany.MashNDash'
...
if [ 1 ]; then
	...
	$ADB $DEVICE shell pm grant com.YourCompany.MashNDash android.permission.READ_EXTERNAL_STORAGE >/dev/null 2>&1
	$ADB $DEVICE shell pm grant com.YourCompany.MashNDash android.permission.WRITE_EXTERNAL_STORAGE >/dev/null 2>&1
